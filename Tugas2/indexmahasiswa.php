...
$db = new Mahasiswa_1(); //membuat objek dari class Mahasiswa_1 yang memiliki akses ke database
$mahasiswa = $db->tampilkanData(); //mengambil semua data mahasiswa yang 
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <table class="table table-stripted table-hover" id="myTable"> 
                <thead >
                  <tr>
